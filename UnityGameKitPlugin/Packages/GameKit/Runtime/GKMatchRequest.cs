...
namespace HovelHouse.GameKit
{
    ...
    public class GKMatchRequest : UnmanagedObject, IDisposable
    {
        ...
        public Action<GKPlayer,GKInviteRecipientResponse> RecipientResponseHandler
        {
            get 
            {
                if(RecipientResponseHandlerCallbacks.TryGetValue(
        ...
        public uint PlayerAttributes
        {
            get
            {
                uint playerAttributes = GKMatchRequest_GetPropPlayerAttributes(Handle);
                return playerAttributes;
            }
            set
            {
                GKMatchRequest_SetPropPlayerAttributes(Handle, value, out IntPtr exceptionPtr);
            }
        }
