...
namespace HovelHouse.GameKit
{
    ...
    public class GKMatchmaker : UnmanagedObject, IDisposable
    {
        ...
        { 
            var val = GKMatchmaker_sharedMatchmaker(
        ...
        private static void MatchForInviteCallback(
            ulong invocationId,
            IntPtr match,
            IntPtr error)
        {
        ...
        private static void AddPlayersToMatchCallback(
            ulong invocationId,
            IntPtr error)
        {
            var invocation = new InvocationRecord(invocationId);
        ...
        private static void FindPlayersForHostedRequestCallback(
            ulong invocationId,
            IntPtr[] players,
		long playersCount,
            IntPtr error)
        ...
        private static void QueryActivityWithCompletionHandlerCallback(
            ulong invocationId,
            long activity,
            IntPtr error)
        {
        ...
        [MonoPInvokeCallback(typeof(QueryActivityDelegate))]
        private static void QueryPlayerGroupActivityCallback(
            ulong invocationId,
            long activity,
            IntPtr error)
        {
        ...
        private static void StartBrowsingForNearbyPlayersWithHandlerCallback(
            ulong invocationId,
            IntPtr player,
            bool reachable)
        {
