...
namespace HovelHouse.GameKit
{
    ...
    public class GKMatch : UnmanagedObject, IDisposable
    {
        ...
        private static void ChooseBestHostingPlayerWithCompletionHandlerCallback(IntPtr thisPtr, ulong invocationId, IntPtr player)
        {
        ...
        private static void RematchWithCompletionHandlerCallback(IntPtr thisPtr, ulong invocationId, IntPtr match, IntPtr error)
        {
            var invocation = new InvocationRecord(thisPtr, invocationId);
