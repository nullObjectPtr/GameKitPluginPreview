...
extern "C" void* GKAchievementDescription_incompleteAchievementImage(
	void** exception
    );

extern "C" void* GKAchievementDescription_placeholderCompletedAchievementImage(
	void** exception
    );
...
// Instance methods 
extern "C" void GKAchievementDescription_loadImageWithCompletionHandler(
	void* ptr,
