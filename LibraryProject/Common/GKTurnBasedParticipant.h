...
extern "C" long GKTurnBasedParticipant_GetPropMatchOutcome(void* ptr);
extern "C" void GKTurnBasedParticipant_SetPropMatchOutcome(void* ptr, long matchOutcome, void** exceptionPtr);
